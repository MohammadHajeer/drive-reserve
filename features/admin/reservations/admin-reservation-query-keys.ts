import {
  normalizeAdminReservationsQuery,
...
export const adminReservationQueryKeys = {
  ...
  list: (query: AdminReservationsQuery = {}) =>
    [
      ...adminReservationQueryKeys.lists(),
      normalizeAdminReservationsQuery(query),
    ] as const,
  details: () => [...adminReservationQueryKeys.all, "detail"] as const,
  detail: (id: string) =>
    [...adminReservationQueryKeys.details(), id] as const,
};
